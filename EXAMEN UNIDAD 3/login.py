...
class Login:
    ...
    def __init__(self,v1):
        ...
        self.window.iconbitmap(r"C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/agen.ico" )

        self.titulo = Label(v1, text="BIENVENIDO GUERRERO", fg="black", bg="azure", font=("Arial", 25, "bold"),pady=5).pack()

        # INSERTAR IMAGEN
        imagen_registro = Image.open(r"C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/FORMULARIOIMG.png")
    ...
    def login(self):
        ...
        if not matricula or not password:
            self.window.destroy()
            call([sys.executable, r'C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/pollo1.py'])
        ...
        if result:
            ...
            self.window.destroy()
            call([sys.executable, r'C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/MENU DESPEGABLE.py'])
    ...
    def register(self):
        self.window.destroy()
        call([sys.executable, r'C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/login2.py' ])
