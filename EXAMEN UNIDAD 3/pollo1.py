...
class MyApp:
    def __init__(self):
        ...
        self.ventana.iconbitmap(r"C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/error.ico")

        img = Image.open(r"C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/pollo1.jpg")
