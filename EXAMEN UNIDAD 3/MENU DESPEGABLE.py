...
class VentanaPrincipal:
    def __init__(self, master):
        ...
        self.master.iconbitmap(r"C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/agen.ico")
        ...
        #Imagen para el menú
        imagen_menu = Image.open(r"C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/MENU.png")
        ...
        imagen_contenido = Image.open(r"C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/FONDO.jpg")
    ...
    def llamar_login(self):
        root.destroy()
        call([sys.executable,r'C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/login.py'])
    def llamar_horario(self):
        root.destroy()
        call([sys.executable, r'C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/HORARIO.py'])

    def llamar_calendario(self):
        root.destroy()
        call([sys.executable, r'C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/CALENDARIO.py'])

    def llamar_mistareas(self):
        root.destroy()
        call([sys.executable, r'C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3\crud.py'])
