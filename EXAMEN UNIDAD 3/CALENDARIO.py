...
#CREAMOS LA VENTANA SU TAMAÑO
    def __init__(self,ventanacalendario):
        ...
        self.ventana.iconbitmap(r"C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/agen.ico")

       #ES EL TITULO AQUI
        titulo=Label(ventanacalendario, text="CALENDARIO",fg="black",bg="azure", font=("Arial", 20,"bold"),pady=10).pack()

        #INSERTAR IMAGEN
        imagen_registro = Image.open(r"C:\Users\miche\PycharmProjects\PYCHARMich\EXAMEN UNIDAD 3/CALENDARIO.jpeg") #ACA CAMBIAR HACIA SU DIRRECION
