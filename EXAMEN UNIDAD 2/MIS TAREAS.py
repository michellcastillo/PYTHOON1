...
class Tareas:
    ...
    def __init__(self, ventana_tarea):
        ...
        self.window.iconbitmap(r"C:\Users\miche\PycharmProjects\pycharm\EXAMEN UNIDAD 2\icono.ico")
        ...
        self.combo_asignatura = ttk.Combobox(marco,values=["POO", "CÁLCULO", "ÁLGEBRA", "CONTABILIDAD","PROBABILIDAD","QUÍMICA"],width=22,font=("Arial", 12, "bold"), state="readonly")
    ...
    def llamar_menu(self):
         ventana_tarea.destroy()
         call([sys.executable, 'c:/Users/miche/PycharmProjects/pycharm/EXAMEN UNIDAD 2/MENU DESPEGABLE.py'])
