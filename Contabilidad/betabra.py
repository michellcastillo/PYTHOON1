...
class VentanaPrincipal(CTk):
    def __init__(self):
        ...
        for materias in resultado:
            ...
            self.treeview.insert(parent='', index='end', iid=identificador, values=(materias[4], materias[5], materias[6], materias[7], materias[8], materias[9], materias[10], materias[11], materias[12], materias[13]), tags="CustomCell")
