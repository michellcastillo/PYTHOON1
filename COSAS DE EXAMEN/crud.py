...
class TareasApp:
    def __init__(self, master):
        ...
        self.master.iconbitmap(r"C:\Users\miche\PycharmProjects\PYCHARMich\COSAS DE EXAMEN\agen.ico")
        ...
        self.descripcion_entry = tk.Entry(marco, width=25, font=("Arial", 12, "bold"))
        ...
        self.actualizar_button = tk.Button(marcofal, text="SALIR", command=self.back, height=2, width=10,
